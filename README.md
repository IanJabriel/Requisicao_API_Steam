...
- Estatísticas tipo quantos jogos nunca foram abertos
- Busca por nome de jogo na sua biblioteca
- URLs das imagens dos jogos (útil para interfaces)

→ Cada versão tem seu próprio README com instruções de como usar.
